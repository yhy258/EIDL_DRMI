...
from .model_utils import model_set_attr, Local_Base
...
class HINet(nn.Module):
    ...
    def __init__(self, config):
        ...
        model_params = {"in_channels" : 3, "wf" : 64, "depth" : 5, "relu_slope" : 0.2, "hin_position_left" : 3, "hin_position_right" : 4}
        model_params = model_set_attr(config, param_dict=model_params)
        
        in_chn = model_params["in_channels"]
        wf = model_params["wf"]
        depth = model_params["depth"]
        relu_slope = model_params["relu_slope"]
        hin_position_left = model_params["hin_position_left"]
        hin_position_right = model_params["hin_position_right"]

...
class MPRNet(nn.Module):
    def __init__(self, config):
        ...
        # initialization
        model_params = {"in_channels" : 3, "n_feat" : 96, "scale_unetfeats" : 48, "scale_orsnetfeats" : 32, "num_cab" : 8, "kernel_size" : 3, "reduction" : 4}
        model_params = model_set_attr(config, param_dict=model_params)
        
        in_c = model_params["in_channels"]
        out_c = model_params["in_channels"]
        n_feat = model_params["n_feat"]
        scale_unetfeats = model_params["scale_unetfeats"]
        scale_orsnetfeats = model_params["scale_orsnetfeats"]
        num_cab = model_params["num_cab"]
